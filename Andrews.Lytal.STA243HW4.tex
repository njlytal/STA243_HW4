...
\end{description}
\item[c.] We implement the Gibbs sampler to generate a large (dependent) sample from the posterior distribution, and use this to construct 95\% Bayesian confidence intervals for $p$ and $\lambda$. 
\end{description}
